...
| --- | --- | --- |
| **Alphabet** | Fingerspelled letters (dactilológico). All 27 letters, six of them unreliable. | GRU trained with CTC on LSE-FS-UVigo, 0.71 MB. On real continuous fingerspelling it writes **76% of the letters** and gets **88% of those right**; **75 of 456** words come out spelled exactly. |
